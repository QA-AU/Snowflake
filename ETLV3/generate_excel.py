...
mapping_fields = [
    ...
    ("target_date_filter",             "$order_date between COL_X1.STRT_DT and COL_X1.END_DT",   False),
...
sample_cols = [
    ("DEMO_TABLE",  "PKCOL1",  "Y", "VARCHAR(100)", "", "", "", "", "COL_1",       "Y", "VARCHAR(100)", "", "", "", "",   "COPY"),
    ("DEMO_TABLE",  "PKCOL2",  "Y", "VARCHAR(100)", "", "", "", "", "RLTD_COL_1",  "Y", "VARCHAR(100)", "", "", "", "",   "COPY"),
    ("DEMO_TABLE",  "RELKIND", "Y", "VARCHAR(100)", "", "", "", "", "COL_3",       "Y", "VARCHAR(100)", "", "", "", "",   "COPY"),
    ("DEMO_TABLE",  "STRT_DT", "N", "VARCHAR(100)", "", "", "", "", "STRT_DT",     "N", "DATE",         "", "", "", "",   "COPY"),
    ("DEMO_TABLE",  "END_DT",  "N", "VARCHAR(100)", "", "", "", "", "END_DT",      "N", "DATE",         "", "", "", "",   "COPY"),
    ("DEMO_TABLE2", "STRT_DT", "N", "DATE",         "", "", "", "", "BUSN_STRT_DT","N", "DATE",         "", "", "", "",   "COPY"),
    ("DEMO_TABLE2", "END_DT",  "N", "DATE",         "", "", "", "", "BUSN_END_DT", "N", "DATE",         "", "", "", "",   "COPY"),
]
...
instructions = [
    ("Layout", "Each mapping has MAPPING INFORMATION (table metadata) followed by COLUMN MAPPINGS. Fields marked (*) are mandatory."),
    ("dedup_logic", "How to handle duplicates. Values: KEEP_FIRST, KEEP_LAST (default), REJECT."),
    ("source_lookup_table", "Optional reference table to join. Example: 'REF_COUNTRY_CODES'."),
    ("Multiple source tables", "If source_table has multiple tables, source_join is required."),
...
for label, desc in instructions:
    ...
    if label:
        ...
        c1.fill = PatternFill("solid", start_color=LABEL_BG if label else WHITE, end_color=LABEL_BG if label else WHITE)
    else:
